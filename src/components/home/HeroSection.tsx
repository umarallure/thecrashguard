...
const HeroSection = () => {
  ...
  const handleFindLawyer = () => {
    ...
    const url = `/case-review?type=${encodeURIComponent(selectedType)}&location=${encodeURIComponent(
      location
    )}`;
    router.push(url);
  };
                  ...
                  >
                    <div className="w-14 h-14 md:w-16 md:h-16 relative">
                      <img
                        ...
                        style={isSelected 
                          ? { filter: 'brightness(0) saturate(100%) invert(42%) sepia(93%) saturate(1352%) hue-rotate(360deg) brightness(104%) contrast(97%)' }
