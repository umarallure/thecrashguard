      ...
      <div className="container max-w-4xl">
        <div className="text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            If you've been involved in an auto accident, you may be entitled to compensation for your injuries, 
            medical bills, lost wages, and pain and suffering. Our network of experienced attorneys can help you 
            navigate the complex legal process and fight for the maximum settlement you deserve.
          </p>
          ...
          <p className="text-sm text-muted-foreground pt-4">
            ✓ No upfront costs &nbsp;•&nbsp; ✓ Free case evaluation &nbsp;•&nbsp; ✓ Available 24/7
          </p>
        </div>
      </div>
    </section>
